...
/* This file contains the Unicode character database, copied from PCRE2, along
with a table for translating particular to general category values. This is
used only for detecting letters when hyphenating. */
...
const ucd_record ucd_records[] = { /* 17076 bytes, record size 12 */
  {    69,      0,      2,      0,      0,   6144,      2, }, /*   0 */
...
const uint16_t ucd_stage1[] = { /* 17408 bytes */
...
const uint16_t ucd_stage2[] = { /* 78080 bytes, block = 128 */
